...
I hope you enjoyed this post! I plan on writing more. If you'd like to get these posts by email, please enter your email address, or you can [subscribe via RSS](https://jamesharris.design/blog/feed.xml). And please feel free to email me your thoughts: james@jamesharris.design
...
<form action="https://cafe.us17.list-manage.com/subscribe/post?u=de4bf90cba33682650d14d747&amp;id=6e5b78ac2c" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate" target="_blank" novalidate>
    <div id="mc_embed_signup_scroll">
	<label for="mce-EMAIL">Get these blog posts emailed to you</label>
	<input type="email" value="" name="EMAIL" class="email" id="mce-EMAIL" placeholder="email address" required>
    <!-- real people should not fill this in and expect good things - do not remove this or risk form bot signups-->
    <div style="position: absolute; left: -5000px;" aria-hidden="true"><input type="text" name="b_de4bf90cba33682650d14d747_6e5b78ac2c" tabindex="-1" value=""></div>
